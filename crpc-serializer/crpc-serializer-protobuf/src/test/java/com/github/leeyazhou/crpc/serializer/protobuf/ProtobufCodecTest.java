...
package com.github.leeyazhou.crpc.serializer.protobuf;
...
public class ProtobufCodecTest {
  ...
  private Serializer codec = new ProtobufSerializer();
  ...
  public void testEncoder() throws Exception {
    ...
    doEncoderAndDecoder(args, List.class);
  }
  ...
  public void testComplexObject() throws Exception {
    // TODO Protostuff 序列化Map, List 等需要对象包裹
