...
public class CrpcConnectException extends CrpcException {
  ...
  public CrpcConnectException() {
    super();
  }

  public CrpcConnectException(String message) {
    super(message);
  }

  public CrpcConnectException(String message, Throwable cause) {
    super(message, cause);
  }

  public CrpcConnectException(Throwable cause) {
    super(cause);
  }
}
